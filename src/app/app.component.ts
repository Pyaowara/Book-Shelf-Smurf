...
export class AppComponent implements OnInit {
  ...
  genres: string[] = [
    'Fiction', 'Fantasy', 'Science Fiction', 'Mystery', 'Horror', 'Romance',
    'Historical Fiction', 'Literary Fiction', 'Young Adult', "Children's",
    'Graphic Novels', 'Dystopian', 'Action', 'Western', 'Nonfiction',
    'History', 'Biography/Autobiography', 'Self-help', 'Science & Technology',
    'Health & Wellness', 'Business & Economics', 'True Crime', 'Travel',
    'Cookbooks', 'Art & Photography', 'Religion & Spirituality', 'Philosophy',
    'Humor', 'Essays', 'Reference', 'Girl Love', 'Boy Love', 'R18+',
    'Light Novel', 'Manga', 'Manwha', 'Manhua', 'Comic', 'SuperHero',
    'Drama', 'Adventure'
  ];
